...
临床数据编程员：   
职位描述： `SAS`、`CDASH\STDM`
工作职责: 1、用SAS编程出列表报告； 2、熟悉STDM处理原始数据集。 任职资格: 1、医药类、理工类(如:IT计算机科学电子工程信息管理等)相关专业本科及以上学历； 2、对临床数据库有良好的理解，具备一年以上临床研发领域的SAS编程经验； 3、精通SAS编程语言，熟练使用SAS编程生成数据列表及报告； 4、对整个临床试验过程及临床试验数据管理的行业标准有很好的理解，尤其是CDASH及STDM； 5、良好的概念观、组织观和交流技巧； 6、尽责的态度和灵活多变的解决办法； 7、与同事、领导以及客户建立并维护有效工作关系的能力。

临床研究人员，涉及到临床数据的产生、管理、分析、报告和提交阶段的主要工作人员有：项目主管或项目经理、统计师、编程人员（SAS编程）、研究者和临床研究助理、临床监察员、临床数据管理员、药物警戒（pharmacovigilance）、医务法务事务、质量保证人员、医学写作人员信息技术与信息管理人员。
